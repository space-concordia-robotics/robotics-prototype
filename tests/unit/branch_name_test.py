...
def test_has_branch_name_error():
    ...
    """
    assert has_branch_name_error('Feat-test-branch-123', error_msg)
    assert has_branch_name_error('feat-test-branch123', error_msg)
    assert has_branch_name_error('feat-test-branch-', error_msg)
    assert has_branch_name_error('fe@t-test-branch-123', error_msg)
    assert has_branch_name_error('----------------------18', error_msg)
    assert has_branch_name_error('feat--test-branch-123', error_msg)
    assert has_branch_name_error('-feat-test-branch-123', error_msg)
    assert has_branch_name_error('test-branch-name-123-', error_msg)
    assert has_branch_name_error('!@dvsfosk*&*&^fs4943', error_msg)
    assert not has_branch_name_error('feat-test-branch-123', error_msg)
    assert not has_branch_name_error('upgrade-ubuntu-18-304', error_msg)
