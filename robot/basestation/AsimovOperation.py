...
# definitions of the handlers for the buttons
    ...
    def on_switch_activated(self, sw):
        ...
        buttons = [
            roll_left_btn, roll_right_btn, claw_open_btn, claw_close_btn, pitch_up_btn, pitch_down_btn, arm_up_btn,
            arm_down_btn, arm_left_btn, arm_right_btn, arm_back_btn, arm_fwd_btn
        ]
        automatic_labels = [
            "Roll\nLeft", "Roll\nRight", "Claw\nOpen", "Claw\nClose", "Pitch\nUp", "Pitch\nDown", "Arm\nUp",
            "Arm\nDown", "Arm\nLeft", "Arm\nRight", "Arm\nBack", "Arm\nFwd"
        ...
        automatic_event_names = [
            "onRollLeftClicked", "onRollRightClicked", "onClawOpenClicked", "onClawCloseClicked", "onPitchUpClicked",
            "onPitchDownClicked", "onArmUpClicked", "onArmDownClicked", "onArmLeftClicked", "onArmRightClicked",
            "onArmBackClicked", "onArmFwdClicked"
        ]
        automatic_callbacks = [
            asimov_op.roll_left_clicked, asimov_op.roll_right_clicked, asimov_op.claw_open_clicked,
            asimov_op.claw_close_clicked, asimov_op.pitch_up_clicked, asimov_op.pitch_down_clicked,
            asimov_op.arm_up_clicked, asimov_op.arm_down_clicked, asimov_op.arm_left_clicked,
            asimov_op.arm_right_clicked, asimov_op.arm_back_clicked, asimov_op.arm_fwd_clicked
        ]
        manual_callbacks = [
            asimov_op.dc_m2_left_clicked, asimov_op.dc_m2_right_clicked, asimov_op.st_m3_left_clicked,
            asimov_op.st_m3_right_clicked, asimov_op.st_m1_left_clicked, asimov_op.st_m1_right_clicked,
            asimov_op.st_m4_left_clicked, asimov_op.st_m4_right_clicked, asimov_op.as_m1_left_clicked,
            asimov_op.as_m1_right_clicked, asimov_op.as_m2_left_clicked, asimov_op.as_m2_right_clicked
        ]
