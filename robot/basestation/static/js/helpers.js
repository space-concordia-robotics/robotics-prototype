...
function enableRoverMotorsBtn() {
    $($(".toggle > #enable-rover-motors-btn")[0].parentNode).removeClass("btn-danger off");
    $($(".toggle > #enable-rover-motors-btn")[0].parentNode).addClass("btn-success");
    $("#enable-rover-motors-btn")[0].checked = true;
}

function disableRoverMotorsBtn() {
    $($(".toggle > #enable-rover-motors-btn")[0].parentNode).addClass("btn-danger off");
    $($(".toggle > #enable-rover-motors-btn")[0].parentNode).removeClass("btn-success");
