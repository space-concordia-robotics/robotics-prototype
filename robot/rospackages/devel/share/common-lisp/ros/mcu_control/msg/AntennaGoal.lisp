...
(cl:defmethod cl:initialize-instance :after ((m <AntennaGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AntennaGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mcu_control-msg:<AntennaGoal> is deprecated: use mcu_control-msg:AntennaGoal instead.")))

(cl:ensure-generic-function 'desiredDir-val :lambda-list '(m))
(cl:defmethod desiredDir-val ((m <AntennaGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcu_control-msg:desiredDir-val is deprecated.  Use mcu_control-msg:desiredDir instead.")
  (desiredDir m))

(cl:ensure-generic-function 'distFromBase-val :lambda-list '(m))
(cl:defmethod distFromBase-val ((m <AntennaGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcu_control-msg:distFromBase-val is deprecated.  Use mcu_control-msg:distFromBase instead.")
  (distFromBase m))
