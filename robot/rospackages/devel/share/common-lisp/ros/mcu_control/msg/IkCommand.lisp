...
(cl:defmethod cl:initialize-instance :after ((m <IkCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IkCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mcu_control-msg:<IkCommand> is deprecated: use mcu_control-msg:IkCommand instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <IkCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcu_control-msg:x-val is deprecated.  Use mcu_control-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <IkCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcu_control-msg:y-val is deprecated.  Use mcu_control-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <IkCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcu_control-msg:z-val is deprecated.  Use mcu_control-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'wrist-val :lambda-list '(m))
(cl:defmethod wrist-val ((m <IkCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mcu_control-msg:wrist-val is deprecated.  Use mcu_control-msg:wrist instead.")
  (wrist m))
