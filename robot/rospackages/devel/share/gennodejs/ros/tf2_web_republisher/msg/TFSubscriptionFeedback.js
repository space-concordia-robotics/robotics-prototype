...
class TFSubscriptionFeedback {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TFSubscriptionFeedback(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TFSubscriptionFeedback(null);
...
module.exports = TFSubscriptionFeedback;
