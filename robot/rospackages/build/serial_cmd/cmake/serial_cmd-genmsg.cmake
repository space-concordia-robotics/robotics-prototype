...
message(STATUS "serial_cmd: 0 messages, 1 services")
...
get_filename_component(_filename "/home/vashmata/Programming/git/robotics-prototype/robot/rospackages/src/serial_cmd/srv/SerialCmd.srv" NAME_WE)
add_custom_target(_serial_cmd_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial_cmd" "/home/vashmata/Programming/git/robotics-prototype/robot/rospackages/src/serial_cmd/srv/SerialCmd.srv" ""
)
...
### Generating Services
_generate_srv_cpp(serial_cmd
  "/home/vashmata/Programming/git/robotics-prototype/robot/rospackages/src/serial_cmd/srv/SerialCmd.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_nodejs(serial_cmd
  "/home/vashmata/Programming/git/robotics-prototype/robot/rospackages/src/serial_cmd/srv/SerialCmd.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_cmd)
  install(CODE "execute_process(COMMAND \"/home/vashmata/Programming/git/robotics-prototype/venv/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_cmd\")")
  # install generated code
  install(
