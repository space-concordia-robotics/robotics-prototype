...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ping_acknowledgment' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vashmata/Programming/git/robotics-prototype/robot/rospackages/install/${idir}'.  ${_report}")
    endif()
