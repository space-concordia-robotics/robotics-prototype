...
#include "I2CTransactionHelper.hpp"
...
struct i2c_msg I2CTransactionHelper::buildPartialSegment(uint8_t* buffer, int length)
{
...
int main()
{
    ...
    I2CTransactionHelper t(0x42); 
    t.writeVector(v).doTransaction(fd); 
    for(int i = 0; i < 50; i++)
    {
        I2CTransactionHelper p(0x42); 
        uint8_t reg = 0xFD; 
        uint16_t len = 0; 
