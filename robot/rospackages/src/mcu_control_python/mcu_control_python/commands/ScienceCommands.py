...
science_out_commands = [("previous_test_tube", 41, []), ("next_test_tube", 42, []), ("go_to_test_tube", 43, [dt.ARG_UINT8]), ("start_calibrating", 44, [dt.ARG_UINT8]),
                        ("get_carousel_index", 39, []), ("estop", 25, []), ("set_servo_angle", 26, [dt.ARG_UINT8, dt.ARG_UINT8]),
                        ("read_limit_switch", 27, [dt.ARG_UINT8])]


science_in_commands = [("carousel_index", 40, handle_carousel_index), ("limit_switch_value", 28, handle_limit_switch_value)]
